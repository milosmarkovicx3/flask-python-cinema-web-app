...
$(document).ready(function() {
    ...
    basic_regex.test(year.val()) ? year.removeClass('is-invalid movie-form-stop') : year.addClass('is-invalid movie-form-stop');
    basic_regex.test(duration.val()) ? duration.removeClass('is-invalid movie-form-stop') : duration.addClass('is-invalid movie-form-stop');
    basic_regex.test(rating.val()) ? rating.removeClass('is-invalid movie-form-stop') : rating.addClass('is-invalid movie-form-stop');
    basic_regex.test(votes.val()) ? votes.removeClass('is-invalid movie-form-stop') : votes.addClass('is-invalid movie-form-stop');
    basic_regex.test(trailer.val()) ? trailer.removeClass('is-invalid movie-form-stop') : trailer.addClass('is-invalid movie-form-stop');
